    ...
    return (
        <div style={{margin: "0 20px"}}>
            ...
            <div className='flex justify-center flex-wrap items-center mt-4'>
                {
                    !userData.isPasswordChanged && <button onClick={() => { setResetPassword(true) }} className='font-semibold mt-2' style={{ bottom: '10px', right: '20px', padding: "7px 10px", backgroundColor: 'rgb(26, 118, 209)', color: "#fff", borderRadius: "6px" }}>Reset Password <ArrowForwardIcon style={{ color: "#fff", paddingLeft: "5px", fontSize: "30px" }} /></button>
                }
                {
                    !userData.isUserInfoChanged && <button onClick={() => { setClassChange(true) }} className='font-semibold ml-3 mt-2' style={{ bottom: '10px', right: '20px', padding: "7px 10px", backgroundColor: 'rgb(26, 118, 209)', color: "#fff", borderRadius: "6px" }}>Select Class <ArrowForwardIcon style={{ color: "#fff", paddingLeft: "5px", fontSize: "30px" }} /></button>
                }
                {
                    userData.isUserInfoChanged && userData.isPasswordChanged && (
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <button onClick={() => { Navigate('/faculty/dashboard') }} className='font-semibold ml-3 mt-2' style={{ bottom: '10px', right: '20px', padding: "7px 10px", backgroundColor: 'rgb(26, 118, 209)', color: "#fff", borderRadius: "6px" }}>Dashboard <ArrowForwardIcon style={{ color: "#fff", paddingLeft: "5px", fontSize: "30px" }} /></button>
                        </div>
                    )
                }
            </div>
